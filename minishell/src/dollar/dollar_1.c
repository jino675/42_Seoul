...
/*   Updated: 2023/09/28 19:44:13 by jiryu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	delete_this_str(t_cmd *cmd, int cur_idx)
{
	int		i;
	char	**new_strs;
...
static void	dollar_strs(t_info *info, t_cmd *cmd)
{
	int	i;
	int	dollar_next_idx;
	int	is_empty_str;
