...
/*   Updated: 2023/04/10 21:56:22 by jiryu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sub_init(t_part *p, t_etc *e, t_stack *a, t_stack *b)
{
	p->a = a->count - e->n_ra;
	p->b = e->n_ra;
	p->c = b->count - e->n_rb;
...
void	together(t_part *p, t_stack *a, t_stack *b, int flag)
{
	if (flag == 1)
	{
...
void	sub_rewind_1(t_part *p, t_stack *a, t_stack *b)
{
...
void	sub_rewind_2(t_part *p, t_stack *a, t_stack *b)
{
