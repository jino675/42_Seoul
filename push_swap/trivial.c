...
/*   Updated: 2023/04/10 18:58:43 by jiryu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	atob_two(t_stack *a)
{
	t_dlist	*tmp1;
	t_dlist	*tmp2;
...
void	btoa_two(t_stack *a, t_stack *b)
{
	t_dlist	*tmp1;
	t_dlist	*tmp2;
...
void	btoa_three(t_stack *a, t_stack *b)
{
	t_dlist	*tmp1;
	t_dlist	*tmp2;
	t_dlist	*tmp3;
