...
/*   Updated: 2023/10/20 18:39:19 by jiryu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	check_closed_vertex(t_vars *v, double x, double y)
{
	if (ceil(x) - STAFF_THRES <= x && x < ceil(x) - MOVING_THRES && \
...
static int	check_opened_vertex(t_vars *v, double x, double y)
{
	if (ceil(x) - STAFF_THRES <= x && x < ceil(x) - MOVING_THRES && \
		ceil(y) - STAFF_THRES <= y && y < ceil(y) - MOVING_THRES && \
		v->minimap_d == 1 && \
